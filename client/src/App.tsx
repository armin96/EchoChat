...
const API_URL = isProd ? '/api' : (import.meta.env.VITE_API_URL || 'http://localhost:3000');
const SOCKET_URL = isProd ? 'https://echochat-1-pa5a.onrender.com' : (import.meta.env.VITE_API_URL || 'http://localhost:3000');
